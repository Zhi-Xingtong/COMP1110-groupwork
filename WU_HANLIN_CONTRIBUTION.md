...
- `case_studies/arrivals_peak_hour.json`
- `case_studies/arrivals_low_traffic.json`
- `case_studies/arrivals_uniform_small.json`
- `case_studies/arrivals_uniform_large.json`
